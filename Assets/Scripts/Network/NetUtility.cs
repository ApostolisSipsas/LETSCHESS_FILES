...
public static class NetUtility
{
    public static void OnData(DataStreamReader stream, NetworkConnection cnn, Server server = null)
    {
        ...
        switch (opCode)
        {
            ...
            case OpCode.LOBBY_REFRESH: msg = new NetLobbyRefresh(stream);  break;
            case OpCode.DRAW:          msg = new NetDraw(stream);           break;
            default:
                Debug.LogError("Net message has no OpCode");
                break;
        }
    ...
    // Events πλευράς πελάτη (client)
    public static Action<NetMessage> C_KEEP_ALIVE;
    public static Action<NetMessage> C_WELCOME;
    public static Action<NetMessage> C_START_GAME;
    public static Action<NetMessage> C_MAKE_MOVE;
    public static Action<NetMessage> C_REMATCH;
    public static Action<NetMessage> C_LOBBY_REFRESH;
    public static Action<NetMessage> C_DRAW;

    // Events πλευράς διακομιστή (server)
    public static Action<NetMessage, NetworkConnection> S_KEEP_ALIVE;
    public static Action<NetMessage, NetworkConnection> S_WELCOME;
    public static Action<NetMessage, NetworkConnection> S_START_GAME;
    public static Action<NetMessage, NetworkConnection> S_MAKE_MOVE;
    public static Action<NetMessage, NetworkConnection> S_REMATCH;
    public static Action<NetMessage, NetworkConnection> S_LOBBY_REFRESH;
